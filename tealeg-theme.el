;;; tealeg-theme.el --- the ol' tealeg's good ol' dark theme.


(deftheme tealeg
  "The ol' tealeg's good ol' dark theme.")

(let ((class '((class color) (min-colors 10)))
      (black "black") ;; #000000
      (white "white") ;; #ffffff
      (lgray "light gray") ;; #d3d3d3
      (dgray "dark gray") ;; #a9a9a9
      (sgray "dim gray")  ;; #696969
      )
  ...
  (custom-theme-set-faces
   ...
   ;; Show-paren
   `(show-paren-match ((t (:background ,dgray :foreground ,black))))
